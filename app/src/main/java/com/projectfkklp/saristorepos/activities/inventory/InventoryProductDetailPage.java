...
public class InventoryProductDetailPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            String product = bundle.getString("_Product");
    ...
    private void editProduct() {
        Intent intent = new Intent(InventoryProductDetailPage.this, InventoryEditProductPage.class);
        intent.putExtra("_Product", detailProduct.getText().toString());
