...
public class _InventoryProductListPage extends AppCompatActivity{

    // Add the following member variable
    private String userUid;
    FirebaseAuth mAuth;
    RecyclerView recyclerView;
    List<_Product> dataList;
    List<_Product> filteredDataList;
    CollectionReference productsCollection;
    ListenerRegistration eventListener;
    AlertDialog dialog;
    _InventoryProductListAdapter adapter;

    @SuppressLint("NotifyDataSetChanged")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout._inventory_product_list_page);
        ...
        adapter = new _InventoryProductListAdapter(this, filteredDataList);
                    ...
                    if (value != null) {
                        ...
                        for (DocumentSnapshot document : value.getDocuments()) {
                            ...
                            if (product != null) {
                                ...
                                Log.e("FirestoreListener", "_Product is null");
                            }
                        }
        ...
        fab.setOnClickListener(v -> {
            Intent intent = new Intent(_InventoryProductListPage.this, _InventoryCreateProductPage.class);
            startActivity(intent);
        });
